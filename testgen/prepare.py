...
DEFAULT_PROMPT = """You are a Senior QA Engineer. Analyze the attached UI screenshots for the 'General' module.
...
def create_batches(
    ...
    print("4. Run 'testgen generate' to create the final Excel.")
